  ...
  <div class="min-h-screen bg-gray-100 p-4 md:p-6">
    ...
    <div class="mb-6">
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
        <div
          class="relative flex items-center border rounded-lg p-2 bg-white w-full sm:w-64"
        >
          ...
          <div
            v-if="showDatePicker"
            class="absolute top-full left-0 mt-1 bg-white shadow-lg rounded-lg p-4 z-10"
          >
        ...
        <div class="flex flex-col md:flex-row items-center justify-center">
          ...
          <div class="mt-4 md:mt-0 md:ml-6 space-y-3">
            <div class="flex items-center">
              <div
                class="h-5 w-5 rounded mr-3"
                style="background-color: #4f7df9"
              ></div>
              <span>Tersedia</span>
            </div>
            <div class="flex items-center">
...
const initChart = () => {
  ...
  if (wheelchairStatusChart.value) {
    wheelchairStatusChartInstance.value = new Chart(
      wheelchairStatusChart.value,
      {
        type: "doughnut",
        data: {
...
const updateAgentPerformanceChart = () => {
  ...
  if (agentPerformanceChart.value) {
    agentPerformanceChartInstance.value = new Chart(
      agentPerformanceChart.value,
      {
        type: "pie",
        data: {
